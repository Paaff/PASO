...
func populateValidClients() {
	...
	ValidClientsMap.Set("54:9B:12:D2:09:4C", Client{"Mathias Mortensen", []Permission{
		Permission{Perm: "ViewA", PermType: "View"},
...
func populateProjects() {
	Projects.Add(Project{ProjectName: "Project A", Content: "This is the information regarding project A and its content.",
		...
		RequiredPermissions: []Permission{Permission{Perm: "ViewA", PermType: "View"},
			Permission{Perm: "OpenA", PermType: "Open"}},
	})
	Projects.Add(Project{ProjectName: "Project B", Content: "This is the information regarding project B and its content.",
		Members: []string{"Mathias Mortensen", "Alberto Lafuente"}, RequiredPermissions: []Permission{Permission{Perm: "ViewB", PermType: "View"},
			Permission{Perm: "OpenA", PermType: "Open"}},
	})
	Projects.Add(Project{ProjectName: "Project C", Content: "This is the information regarding project C and its content.",
		Members: []string{"Peter Fischer"}, RequiredPermissions: []Permission{Permission{Perm: "ViewC", PermType: "View"},
			Permission{Perm: "OpenC", PermType: "Open"}},
	})
}
